...
export function Navbar() {
  ...
  const [activeDropdown, setActiveDropdown] = useState<"product" | "services" | "solutions" | null>(
    null,
  );
          ...
          <nav ref={navRef} className="ml-auto hidden items-center gap-8 md:flex">
            <div className="group relative flex h-24 items-center">
              <a
                ...
                onClick={(event) => {
                  event.preventDefault();
                  setActiveDropdown((current) => (current === "product" ? null : "product"));
                }}
            ...
            <div className="group/services relative flex h-24 items-center">
              <a
                ...
                onClick={(event) => {
                  event.preventDefault();
                  setActiveDropdown((current) => (current === "services" ? null : "services"));
                }}
            ...
            <div className="group/solutions relative flex h-24 items-center">
              <a
                ...
                onClick={(event) => {
                  event.preventDefault();
                  setActiveDropdown((current) => (current === "solutions" ? null : "solutions"));
                }}
