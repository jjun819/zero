...
const CountDownCurrency = ({ startValue, endValue }: { startValue: number; endValue: number }) => {
      ...
      <div className="mx-auto max-w-[1380px] px-5 md:px-8">
        <div className="max-w-3xl">
          <h2 className="text-4xl font-semibold tracking-tight md:text-5xl lg:text-6xl">
            <span className="text-foreground">
              Our zero-cost solution for property owners.
            </span>{" "}
          </h2>
        ...
        <div className="mt-14">
          <div className="grid gap-6 lg:items-stretch xl:grid-cols-[800px_minmax(320px,1fr)]">
            <div className="relative rounded-xl border border-[#B8E5D6] bg-[#EAF7F2] shadow-[0_20px_60px_rgba(15,23,42,0.08),inset_0_1px_0_rgba(255,255,255,0.75)] backdrop-blur-xl">
              <div className="grid">
                <div className="flex h-full flex-col items-center p-7 md:p-10">
                  ...
                  <p className="mx-auto mt-5 max-w-sm text-center text-base leading-relaxed text-black">
                    UbiqPower owns the chargers and pays for design, equipment, and installation.
                    The property contributes EV-ready stalls and electrical capacity - nothing more.
                  </p>
                </div>
              </div>
            </div>

            <div className="overflow-hidden rounded-xl border border-[#B8E5D6] bg-[#EAF7F2] shadow-[0_20px_60px_rgba(15,23,42,0.08),inset_0_1px_0_rgba(255,255,255,0.75)] backdrop-blur-xl">
              <img
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-3">
          {[
            ...
            return (
              <div
                key={item.heading}
                className="relative rounded-xl border border-[#B8E5D6] bg-[#EAF7F2] p-6 pr-16 shadow-[0_16px_45px_rgba(15,23,42,0.06),inset_0_1px_0_rgba(255,255,255,0.75)] backdrop-blur-xl"
              >
                <div className="absolute right-5 top-5 flex h-8 w-8 items-center justify-center rounded-lg border border-[#B8E5D6] bg-white/70 text-[#2D865B]">
